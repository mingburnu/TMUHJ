--accountNumber
insert into accountNumber(serNo, cUid, uUid, cDTime, uDTime, cus_serNo, userID, userName, userPW, role, status) values(1, 'admin', 'admin' , sysdate(), sysdate(), 1,'admin', 'administer', '8w5y4CYvLHP69kq5Wm2vHDVfPX1IOcrpskUugS/4KZN6budffcIYbfhpEL6HmNZ0', 'R01','S01');
insert into accountNumber(serNo, cUid, uUid, cDTime, uDTime, cus_serNo, userID, userName, userPW, role, status) values(2, 'admin', 'admin' , sysdate(), sysdate(), 5, 'user', 'Default User', '', 'R04','S01');
...
--database
insert into db(serNo, cUid, uUid, cDTime, uDTime, DBchttitle, DBengtitle) values(1, 'admin''s', 'admin' , sysdate(), sysdate(), '歷史', 'History');
...
--resourcesBuyers
insert into resourcesBuyers(serNo, cUid, uUid, cDTime, uDTime, startdate, maturitydate, Rcategory, Rtype, DBchttitle, DBengtitle) values(1, 'admin', 'admin' , sysdate(), sysdate(),'1980', '2020', 'RC1', 'RT3', '醫學', 'Medcine');
insert into resourcesBuyers(serNo, cUid, uUid, cDTime, uDTime, startdate, maturitydate, Rcategory, Rtype, DBchttitle, DBengtitle) values(2, 'admin', 'admin' , sysdate(), sysdate(),'1980', '2020', 'RC1', 'RT3', '醫學', 'Medcine');
